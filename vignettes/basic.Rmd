...
```{r specify-directories, include = FALSE}
...
Note that mask image must be have **same width and height** as mapping data, and should be either `bmp` or `png` format. `jpg` is allowed but not recommended as it is a lossy format.
